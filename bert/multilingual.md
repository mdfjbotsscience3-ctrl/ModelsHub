...
This documentation is based on the official BERT documentation written by Google Research.
...
All original documentation content belongs to Google Research and is reused/adapted under the terms of the Apache 2.0 License.

This project (MDFJ Models Hub) does not claim ownership of the original documentation.
